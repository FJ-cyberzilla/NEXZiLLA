...
"""
    ...
    async def whois_lookup(self, args):
        ...
        try:
            ...
            print(f"[WHOIS] Name Servers: {', '.join(whois_info.name_servers) if whois_info.name_servers else 'N/A'}")
        except Exception as e:
    ...
    async def geoip_lookup(self, args):
        ...
        try:
            ...
            if 'error' not in data:
                print(f"[GEOIP] Country: {data.get('country_name', 'N/A')}")
                print(f"[GEOIP] Region: {data.get('region', 'N/A')}")
                print(f"[GEOIP] City: {data.get('city', 'N/A')}")
                print(f"[GEOIP] ISP: {data.get('org', 'N/A')}")
                return data
            else:
...
if __name__ == "__main__":
    terminal = ProductionCyberTerminal()
